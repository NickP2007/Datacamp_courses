...
Instructions: Which Avocado Size is Most Popular?
...
Instructions: Changes in Sales Over Time
...
nb_sold_by_date.plt(kind = line)

# Show the plot
plt.show()


Instructions: Avocado Supply and Demand
...
Instructions: Price of Conventional vs. Organic Avocados
# 1/3
...
avocados[avocados["type"] == "conventional"]["avg_price"].hist(alpha = .5, bins = 20)
avocados[avocados["type"] == "organic"]["avg_price"].hist(alpha = .5, bins = 20)


Instructions: Finding Missing Values 
...
Instructions: Removing Missing Values
...
Instructions: Replacing Missing Values
# 1/2
...
Instructions: Dictionary of Lists
